...
namespace OnShop.DAL.Product.Configs
{
    public class ProductConfig : IEntityTypeConfiguration<Domain.Product.Entities.Product>
    {
        public void Configure(EntityTypeBuilder<Domain.Product.Entities.Product> builder)
        {
            ...
            builder.Property(x => x.ShortDescription).HasColumnType("nvarchar(1500)").HasMaxLength(1500).IsRequired();
            ...
            builder.Property(x => x.Tag).HasColumnType("nvarchar(450)").HasMaxLength(450);
