...
namespace OnShop.Web.Common.TagHelpers
{
    ...
    [HtmlTargetElement("drop-down-list-font-awesome", Attributes = FormatAttributeName)]
    public class FonwtAwsomeDropDownTagHelper : Microsoft.AspNetCore.Razor.TagHelpers.TagHelper
    {
        private const string FormatAttributeName = "asp-for";
        private string htmlCode = @"
   <select class=""form-control"" name=""Icon"">
    <option value=""fa"">انتخاب کنید</option>
